// Keeps navigation bar on top of page if scrolled past
$(document).ready(function(){
  /*
  Reaching the bottom of the page causes the navigation bar to only be half showing,
  causing the scroll to glitch out, and the bottom to be unreachable.
  ...
  */
  ...
  /*
  Toggle "fixed-topcenter" class based on whether the anchor is passed or not
  and whether main div is big enough to avoid glitch (mentioned above).
